...
: public QObject
{
	...
	public:
		 ...
		 * \param[in] mainWindow Raw pointer of the widget parent of this one. 
		 *
		 */
		explicit QTaskBarButton(QWidget *mainWindow = nullptr);
	...
	private:
		...
		QWidget *m_mainWindow; /** parent widget pointer. */
